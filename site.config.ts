...
export const SERVICES: Service[] = [
  ...
  // ── SWRV COVERAGE — event content, packaged in fixed on-site blocks at
  // $500 per on-site hour rather than left open-ended. Fixed + one-time, so
  ...
  },
  {
    ...
    deliveryDays: 1,
    includes: ['Pre-event content plan', '2 hours on-site coverage', 'Real-time story posting to your socials', '12 edited reels', 'Raw footage delivered'],
  },
  {
    id: 'coverage-full-convoy',
    name: 'The Full Convoy',
    category: 'execution',
    price: '$1,500',
    priceNumeric: 1500,
    checkoutEnabled: true,
    ...
    deliveryDays: 1,
    includes: ['Pre-shoot strategy call', 'Shot list built with you', '3 hours on-site coverage', 'Real-time story + reel posting throughout', '18 edited reels', 'Raw footage delivered'],
  },
  {
    id: 'live-streaming',
