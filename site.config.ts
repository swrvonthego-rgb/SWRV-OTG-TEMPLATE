...
export const SERVICES: Service[] = [
  ...
  },
  {
    ...
    deliveryDays: 1,
    includes: ['2 hours on-site', 'Pre-shoot questionnaire', 'Custom mood board', 'Content strategy + planning', 'Creative direction on-site', 'iPhone + video content', 'Real-time story posting to your socials', '12 edited reels', 'Raw footage delivered'],
  },
  {
    ...
    deliveryDays: 1,
    includes: ['3 hours on-site', 'Pre-shoot strategy call + concept', 'Mood board + shot list', 'Creative direction on-site', 'iPhone + video content', 'Professional photographer', 'Edited brand photos', 'Up to 3 looks', 'Real-time story + reel posting throughout', '12 edited reels', 'Raw footage delivered'],
  },
  {
    id: 'live-streaming',
